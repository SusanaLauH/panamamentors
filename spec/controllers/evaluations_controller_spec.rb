...
describe EvaluationsController do
  ...
  let(:valid_attributes) { { "evaluated" => "2013-09-07" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved evaluation as @evaluation" do
        ...
        post :create, {:evaluation => { "evaluated" => "invalid value" }}, valid_session
        assigns(:evaluation).should be_a_new(Evaluation)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested evaluation" do
        ...
        Evaluation.any_instance.should_receive(:update_attributes).with({ "evaluated" => "2013-09-07" })
        put :update, {:id => evaluation.to_param, :evaluation => { "evaluated" => "2013-09-07" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the evaluation as @evaluation" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Evaluation.any_instance.stub(:save).and_return(false)
        put :update, {:id => evaluation.to_param, :evaluation => { "evaluated" => "invalid value" }}, valid_session
        assigns(:evaluation).should eq(evaluation)
      end
